...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/Fig1.pdf}
...
\begin{figure}[ht!]
\begin{center}
    %\includegraphics[width=0.75\textwidth]{PLOS_figures/Fig2.pdf}
...
\begin{figure}[ht!]
\begin{center}
    %\includegraphics[width=0.75\textwidth]{PLOS_figures/Fig3.pdf}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/Fig4.pdf}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/Fig5.pdf}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/Fig6.pdf}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/Fig7.pdf}
...
\begin{figure}[ht!]
\begin{center}
    %\includegraphics[width=0.75\textwidth]{PLOS_figures/Fig8.pdf}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/Fig9.pdf}
...
\begin{figure}[ht!]
   %\includegraphics[width=\textwidth]{PLOS_figures/Fig10.pdf}
...
\begin{figure}[ht!]
\begin{center}
    %\includegraphics[width=0.75\textwidth]{PLOS_figures/Fig11.pdf} %was figures/sensitivity/numDrones.pdf
...
%\bibliography{refs} -- use this to generate references from refs.bib if needed. Then copy-paste the contents from .bbl file to replace the below.

\begin{thebibliography}{10}

\bibitem{gwilliam2008burden}
...
\bibitem{teytelman2013multiregional}
...
\bibitem{poncin2018implementation}
...
\begin{figure}[ht!]
  %\includegraphics[width=\textwidth]{PLOS_figures/S1Fig.pdf}
\end{figure}
...
\begin{figure}[ht!]
  %\includegraphics[width=\textwidth]{PLOS_figures/S2Fig.pdf}
\end{figure}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/S3Fig.pdf}
\end{figure}
...
\paragraph*{S8 Fig.}
\label{SI:S8_fig}
{\bf Generic network structure maps:}
The population size at each network location is represented by the radius of the dot, and the epicentre is marked in red. The monocentric network is top left, the polycentric network is top right, the city-type network is bottom left, and the rural-type network is bottom right.

\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/S8Fig.pdf}
\end{figure}

\paragraph*{S9 Table}
\label{SI:S9_table_niamey}
...
\begin{figure}[ht!]
    %\includegraphics[width=\textwidth]{PLOS_figures/S10Fig.pdf}
\end{figure}
